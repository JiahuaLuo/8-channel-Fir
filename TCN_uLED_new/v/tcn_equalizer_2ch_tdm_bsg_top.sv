module tcn_equalizer_2ch_tdm_bsg_top #(
  parameter int CH  = 2,
  ...
  input  logic [DW+$clog2(CH)-1:0] data_link_data,
  ...
  assign {sample_channel_id, sample_data_u8} = data_link_data;
  ...
  tcn_equalizer_2ch_tdm #(
    .CH(CH),
    .TAP(TAP),
    .DW(DW),
    .WW(WW),
    .AW(AW)
  ) u_tcn_equalizer_2ch_tdm (
    .clk(clk),
    .rst_n(rst_n),
