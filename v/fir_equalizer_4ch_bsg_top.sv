module fir_equalizer_4ch_bsg_top #(
  parameter int CH  = 4,
  ...
  logic [CH-1:0]          last_out_bit;
  logic [CH-1:0]          seen_out_valid;
  logic [CH-1:0]          seen_bit_valid;
  logic [31:0]            mode_summary;

  assign mode_summary = {30'd0, bypass_en, offset_en};
  ...
  probe_mux_4ch #(
    ...
    .probe_ch_sel    (probe_ch_sel),
    .probe_sig_sel   (probe_sig_sel),
    .last_in_data_u8     (last_in_data_u8),
    .last_raw_fir_out_u8 (last_raw_fir_out_u8),
    .last_final_out_u8   (last_final_out_u8),
    .last_out_bit        (last_out_bit),
    .seen_out_valid      (seen_out_valid),
    .seen_bit_valid      (seen_bit_valid),
